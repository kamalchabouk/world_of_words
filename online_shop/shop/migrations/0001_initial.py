# Generated by Django 4.2.11 on 2024-04-12 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField(blank=True, default=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paypal_address', models.EmailField(blank=True, max_length=255, null=True)),
                ('bank_name', models.CharField(blank=True, max_length=100, null=True)),
                ('account_number', models.CharField(blank=True, max_length=50, null=True)),
                ('iban', models.CharField(blank=True, max_length=50, null=True)),
                ('book', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='shop.book')),
